    ...
    private void StartClimbing()
{
    ...
    {
        // Set the player's climbing state in the Cat script
        playerRigidbody.gameObject.GetComponent<Cat>().isClimbing = true;
        
        // Set isGrounded to false to prevent jumping or other ground-related actions
        playerRigidbody.gameObject.GetComponent<Cat>().isGrounded = false;
        
        // Disable gravity for climbing
        playerRigidbody.gravityScale = 0; 
        
        // Stop any previous momentum
