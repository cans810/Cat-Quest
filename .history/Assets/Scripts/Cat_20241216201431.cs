...
public class Cat : MonoBehaviour
{
        ...
        if (other.CompareTag("Ladder"))
        {
            ...
            if (ladder != null)
            {
                ...
                if (currentLadder == null || IsCloserLadder(ladder))
                {
                    ...
                    rb.velocity = Vector2.zero; // Stop any previous motion
                }
            }
        }
    }
    ...
    private bool IsCloserLadder(GameObject ladder)
    {
        float distanceToNewLadder = Vector2.Distance(transform.position, ladder.transform.position);
        float distanceToCurrentLadder = Vector2.Distance(transform.position, currentLadder.transform.position);
