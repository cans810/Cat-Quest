...
public class Cat : MonoBehaviour
{
    ...
    public void Kill()
    {
        ...
        GameObject parent = GameObject.Find("ScreenCanvas");

        // Find the child by name
        Transform child = parent.transform.Find("YouDied");

        if (child != null)
        {
            // Set the child active
            child.gameObject.SetActive(true); // Activate
            Debug.Log("Child activated: " + child.gameObject.name);
        }
        else
        {
