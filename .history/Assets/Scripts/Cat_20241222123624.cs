...
public class Cat : MonoBehaviour
{
    ...
    private float ladderXPosition; // Store ladder position
    ...
    private void HandleClimbing()
    {
        ...
        {
            // Stop all movement when no input
            rb.velocity = Vector2.zero;
        }

        // Keep the player centered on the ladder
        Vector3 newPosition = transform.position;
        newPosition.x = ladderXPosition;
    ...
    private void ToggleClimbing()
    {
        ...
        if (isClimbing)
        {
            ...
            // Snap to ladder position with offset based on facing direction
