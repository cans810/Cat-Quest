...
public class Cat : MonoBehaviour
{
    ...
    {
        isAttacking = true;
        animator.SetBool("Attack1", true); // Trigger attack animation

        // Optionally, you can add a delay here to stop the attack animation after a short period
        StartCoroutine(ResetAttackState());
    }

    private IEnumerator ResetAttackState()
    {
        // Wait for the attack animation to complete (example: 0.5 seconds)
