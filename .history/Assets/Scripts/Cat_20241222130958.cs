...
public class Cat : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isClimbing)
        {
            ...
            // Only check for starting climbing when not already climbing
        ...
        else
        {
            ...
            // Only check for stopping climbing when already climbing
    ...
    private void StartClimbing()
    {
        ...
        float offsetX = -0.60f;
        // Add liftOffset here to slightly lift the player
        transform.position = new Vector2(ladderXPosition + offsetX, transform.position.y + liftOffset);
    ...
    private void HandleClimbing()
    {
        ...
        if (Mathf.Abs(verticalInput) > 0.1f)
        {
            rb.velocity = new Vector2(0f, verticalInput * climbingSpeed); // Use climbingSpeed instead of moveSpeed
        }
        else
        {
            rb.velocity = Vector2.zero;
