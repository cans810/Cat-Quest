...
public class Cat : MonoBehaviour
{
    ...
    [Header("Wall Jumping")]
    public float wallJumpForceX = 800f;     // Horizontal force towards wall
    public float wallJumpForceY = 600f;     // Upward force for wall jump
    public float wallSlideSpeed = 3f;       // How fast you slide down walls
    public float wallDetectionRadius = 0.3f; // Size of wall detection circle
