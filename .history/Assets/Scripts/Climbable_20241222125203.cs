...
public class Cat : MonoBehaviour
{
    ...
    public bool isClimbing 
    {
        ...
        { 
            _isClimbing = value;
            // Update physics when climbing state changes
            if (_isClimbing)
            {
                rb.gravityScale = 0f;
    ...
    private void HandleClimbing()
    {
        ...
        // Ensure position is locked to ladder
    ...
    private void StartClimbing()
    {
        ...
        // Snap to ladder position with offset
        float offsetX = -0.60f;
        transform.position = new Vector2(ladderXPosition + offsetX, transform.position.y);
        
        // Set a fixed scale while climbing - always face right
...
public class Climbable : MonoBehaviour
{
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            if (catScript != null && catScript._isClimbing)
            {
