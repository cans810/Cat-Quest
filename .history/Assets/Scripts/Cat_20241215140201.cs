    ...
    void FixedUpdate()
{
    if (!isClimbing)
    {
        // Check for wall collisions with a slight buffer
        ...
        for (int i = 0; i < contactCount; i++)
        {
            ...
            {
                // Add a small buffer to allow some movement when touching the wall
        ...
        // Apply movement only if not touching a wall or if there's no input
